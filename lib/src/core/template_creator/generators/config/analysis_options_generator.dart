...
class AnalysisOptionsGenerator extends ConfigGeneratorBase {
  ...
  String generateContent(ScaffoldConfig config) {
    ...
    buffer
      ...
      ..writeln('    unnecessary_nullable_for_final_variable_declarations: error')
      ..writeln()
      ..writeln('    # 忽略的规则')
      ..writeln('    todo: ignore')
    ...
    buffer
      ...
      ..writeln('    - iterable_contains_unrelated_type')
      ..writeln('    - list_remove_unrelated_type')
