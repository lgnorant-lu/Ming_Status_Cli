  ...
  group('Task 50.1: 用户体验优化测试', () {
    ...
    group('错误信息优化测试', () {
      ...
      test('应该提供有用的建议', () async {
        ...
        // 验证是否提供了建议
        final output = '${typoResult.stdout} ${typoResult.stderr}'.toLowerCase();
        expect(output, anyOf([
          contains('init'),
          contains('help'),
          contains('建议'),
    ...
    group('错误恢复测试', () {
      test('应该优雅地处理文件系统错误', () async {
        ...
        final nonExistentParent = path.join(tempDir.path, 'nonexistent', 'child');
